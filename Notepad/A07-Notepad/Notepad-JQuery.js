        ...
        success: function (data) {
            ...
            if (data != null && data.d != null) {
                ...
                if (response.status != null && response.status != "") {
                    ...
                    // checking if the working text area is empty, if not, re-able the buttons
                    if (document.getElementById("pageTextArea").value != null && (document.getElementById("pageTextArea").value).trim() !== '')
                    {
